"""
Django settings for global_egg_bank_43545 project.
...
ROOT_URLCONF = 'global_egg_bank_43545.urls'
...
WSGI_APPLICATION = 'global_egg_bank_43545.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "global_egg_bank_43545 API",
    "DESCRIPTION": "API documentation for global_egg_bank_43545 App",
    "VERSION": "v1",
}
